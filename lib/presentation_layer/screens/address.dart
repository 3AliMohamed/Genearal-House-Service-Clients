...
class Address extends StatefulWidget {
  Address({Key? key, this.orderDetails, this.dataIndex, this.isShowed = true})
      : super(key: key);
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: ListView.builder(
                            ...
                            itemCount: GetAddressCubit.get(context)
                                .addressResponse
                                ?.length,
                              ...
                              return InkWell(
                                onTap: () {
                                  setState(() {
                                    ...
                                    chosenAddress = {
                                      'id':
                                          '${GetAddressCubit.get(context).addressResponse![index].id.toString()}',
                                      'locationType':
                                          '${GetAddressCubit.get(context).addressResponse![index].locationType!}',
                                      'detailedAddress':
                                          '${GetAddressCubit.get(context).addressResponse![index].detailedAddress!}'
                                    };
                                  });
                                },
                                  ...
                                  child: Column(
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          BlocBuilder<GetAddressCubit,GetAddressStates>(
                                            builder: (context, state) {
                                              log("checked cubit of index:${index}" + GetAddressCubit.get(context).checkedItems[index].toString());
                                              return Row(
                                                children: [
                                                  if (widget.isShowed)
                                                    Checkbox(
                                                      key: UniqueKey(),
                                                      value: GetAddressCubit.get(context).checkedItems[index],
                                                      activeColor: Colors.green, // Color when checked
                                                      onChanged: (value) {
                                                        log("checked value: $value");
                                                        log("checked cubit before:" + GetAddressCubit.get(context).checkedItems[index].toString());
                                                        GetAddressCubit.get(context).checked(value ?? false,index);
                                                        log("index" + index.toString());
                                                        log("after:" + index.toString()+" here "+GetAddressCubit.get(context).checkedItems[index].toString());
                                                      },
                                                    ),
                                                  locationType[GetAddressCubit.get(
                                                                          context).addressResponse![index]
                                                                      .locationType].toString() ==
                                                              '' ||
                                                          locationType[GetAddressCubit
                                                                          .get(
                                                                              context)
                                                                      .addressResponse![
                                                                          index]
                        ...
                        InkWell(
                          ...
                          child: Container(
                            margin: EdgeInsets.only(
                                top: widget.isShowed ? 20.sp : 60.sp),
                            padding: EdgeInsets.all(5.sp),
                            width: 400.w,
                            height: 43.h,
                            decoration: BoxDecoration(
                        ...
                        if (widget.isShowed)
                          InkWell(
                            onTap: () {
                              ...
                              if (chosenAddress.values.any((value) => value.toString().trim().isEmpty)) {
