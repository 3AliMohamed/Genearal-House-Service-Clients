                                                ...
                                                children: [
                                                  if (widget.isShowed)
                                                    Checkbox(
                                                      ...
                                                      activeColor: Colors.black.withOpacity(0.1), // Color when checked
                                                      onChanged: (value) {
                                                  ...
                                                  locationType[GetAddressCubit.get(context).addressResponse![index].locationType].toString() == '' ||
                                                      locationType[GetAddressCubit.get(context).addressResponse![index].locationType].toString() == null
                                                      ? Container()
                                                      : Image.asset(
                                                    locationType[
                                                    GetAddressCubit.get(context).addressResponse![index].locationType!.toString()]!,
                                                    width: 50.w,
                                                    height: 50.h,
                                                  ),
                                                  Text(
